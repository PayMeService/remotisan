...
const HistoryTable = ({ baseUrl = '', activeUuid, setActiveUuid, historyRefresh }) => {
    ...
    useEffect(() => {
        ...
        fetch(`${baseUrl}/filters`)
            ...
            .then((data) => {
                ...
                setUsers([...data.users.map((item) => ({ key: item, name: item })), { key: 'null', name: 'All' }]);
            })
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-700">Command</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-700">UUID</th>
                    ...
                    {historyRecords.map((record) => (
                        <tr key={record.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-2 text-sm text-gray-900">{record.user_identifier}</td>
                    ...
                    {pagination.map((link, idx) => (
                        <button
                            ...
                            className={`px-3 py-1 rounded ${
                                link.url ? 'bg-blue-500 text-white hover:bg-blue-600' : 'bg-gray-300 text-gray-600 cursor-not-allowed'
                            }`}
                        >
